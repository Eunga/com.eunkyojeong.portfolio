        ...
        <div class="row">
          <div class="order-sm-last order-md-1 col-md-6 col-sm-12">
            ...
            <div>
              ...
              <i
                style="color:#bbbbbb;"
              >All information in this case study is my own and does not necessarily reflect the views of Daum Webtoon Company.</i>
            </div>
          </div>
      ...
      <div class="portfolio-work v-container-fluid">
        ...
        <div class="row animatable fadeInUp">
          <div class="offset-md-3 col-md-6 offset-sm-0 col-sm-12">
            ...
            <br />Provide users with app that allows them to fully focus on reading and only reading which we believe is the core value of the service.
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="portfolio-work v-container-fluid">
        ...
        <div class="row animatable fadeInUp">
          <div class="offset-md-3 col-md-6 offset-sm-0 col-sm-12">
            ...
            >1. Enable full payment for all or selected episodes at once for each webtoon.</div>
          </div>
        </div>
        ...
        <div class="row animatable fadeInUp">
          <div class="offset-md-3 col-md-6 offset-sm-0 col-sm-12">
            <div
              class="portfolio-work-title subtitle-lg"
            >2. Omit redundant steps to offer faster and easier service.</div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="portfolio-work v-container-fluid">
        <div class="row">
          <div class="col-sm-5 offset-xs-2 col-xs-8">
            ...
            <div style="color:#666666; font-size: 22px; text-align:center;">Before</div>
          </div>
          ...
          <div id="arrowAfterAndBefore" class="col-sm-2 hidden-xs">
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="80" viewBox="0 0 40 80">
              <g transform="translate(-940 -7491)">
                ...
                <path
                  class="b"
                  d="M105.523,9622.243l33.767,33.767-33.767,33.768"
                  transform="translate(837.593 -2124.743)"
                />
              </g>
            </svg>
          </div>
          ...
          <div class="col-sm-5 offset-xs-2 col-xs-8">
            ...
            <div style="color:#666666; font-size: 22px; text-align:center;">After</div>
          </div>
        </div>
      </div>
    </div>
